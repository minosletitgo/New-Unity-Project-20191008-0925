...
[CustomEditor(typeof(UIGridEx), true)]
public class UIGridExEditor : UIWidgetContainerEditor
{
    public override void OnInspectorGUI()
    {
        ...
        NGUIEditorTools.DrawProperty("DirectionAdd", serializedObject, "mIsDirectionAdd");
        NGUIEditorTools.DrawProperty("IntervalPixel", serializedObject, "mIntervalPixel");
