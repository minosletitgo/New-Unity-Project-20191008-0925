...
static public class NGUIEditorTools
{
    ...
    /// <summary>
    /// Draw the specified sprite and view in atlas
    /// </summary>

    static public void DrawSpriteAndViewInAtlas(Rect rect, UISprite sprite)
    {
    ...
    static public void DrawSpriteAndViewInAtlas(Rect rect, UIAtlas atlas, string spriteName)
    {
        ...
        if (atlas.GetSprite(spriteName) == null) return;
        ...
        NGUIEditorTools.DrawSprite(tex, rightRect, sd, /*sprite.color*/Color.white);
    }
