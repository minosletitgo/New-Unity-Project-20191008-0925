...
public class UIPanel : UIRect
{
    ...
    public delegate void OnClippingMoved(UIPanel panel, Vector2 v2Delta);
	...
	public Vector2 clipOffset
	{
		...
		set
		{
			...
			{
                Vector2 v2Delta = value - mClipOffset;
                mClipOffset = value;
				InvalidateClipping();

                // Call the event delegate
                if (onClipMove != null) onClipMove(this, v2Delta);
#if UNITY_EDITOR
                if (!Application.isPlaying) UpdateDrawCalls(list.IndexOf(this));
#endif
			}
	...
	public Vector4 baseClipRegion
	{
		...
		set
		{
				...
				Mathf.Abs(mClipRange.w - value.w) > 0.001f)
			{
                ...
                if (onClipMove != null) onClipMove(this, Vector2.zero);
#if UNITY_EDITOR
                if (!Application.isPlaying) UpdateDrawCalls(list.IndexOf(this));
#endif
			}
